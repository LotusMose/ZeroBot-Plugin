...
func init() {
	...
	url := flag.String("u", "ws://111.31.200.226:8080", "Set Url of WSClient.")
	// 默认昵称
	adana := flag.String("n", "鹤城", "Set default nickname.")
	...
	// 通过代码写死的方式添加主人账号
	// sus = append(sus, 77839441)
	// sus = append(sus, 2052794331)
	...
	config.Z = zero.Config{
		NickName:      append([]string{*adana}, "鹤鹤"),
